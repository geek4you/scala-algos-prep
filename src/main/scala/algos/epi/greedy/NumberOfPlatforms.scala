...
/**
  ...
  */
/**
  * @see http://www.geeksforgeeks.org/minimum-number-platforms-required-railwaybus-station/
  *
  ...
  *       = 3
  **/
object NumberOfPlatforms {
  def minPlatforms(arr: Array[Int], dep: Array[Int]): Int = {
    ...
    var plat_needed = 0
    // minimum number of platforms to return
    var result = 0
    while ( {
      i < arr.length && j < dep.length
  ...
  def main(args: Array[String]): Unit = {
    ...
    System.out.println("Required Platforms : " + minPlatforms(arr, dep))
  }
}
